...
def parse_args():
    ...
    parser.add_argument('-b', '--batch_size', default=32, type=int, help="Batch size for training")
    parser.add_argument('-d', '--device', default='cuda', help="Device for training (default: cuda)")
    parser.add_argument('-t', '--train_epochs', default=200, type=int, help="Number of epochs for training (default: 50)")
    parser.add_argument('-l', '--learning_rate', default=0.01, type=float, help="Learning rate for training (default: 0.001)")
    parser.add_argument('-c', '--checkpoint_dir', default='E:/bird_sound_classification/BirdMLClassification-main/SSL_Net/models/audio/MFCC_resnet18/', help="Directory to save checkpoints (default: checkpoints)")
    parser.add_argument('-s', '--seed', type=int, default=42, help="Random seed for reproducibility")
    parser.add_argument('-a', '--augmentation', nargs='*', choices=['none', 'mixup', 'specaugment', 'RandomReplacementSpecAugmentation', 'specmix'],
                        default=['none'], help="Data augmentation methods to use (default: none)")
    return parser.parse_args()
