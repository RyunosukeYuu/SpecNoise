...
# data_loader = BirdSoundLoader(input_path='D:/WMWB/raw', test=0.2, random_seed=42, feature_type='all_feature')
...
#
# train_loader = DataLoader(TensorDataset(trainX, trainY), batch_size=64, shuffle=True)
# test_loader = DataLoader(TensorDataset(testX, testY), batch_size=64, shuffle=False)
=======
import math
import os
import argparse
